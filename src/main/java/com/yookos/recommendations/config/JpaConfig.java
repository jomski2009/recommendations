...
@Configuration
@EnableJpaRepositories(basePackages="com.yookos.recommendations.jpa")
...
public class JpaConfig {
	...
	public BoneCPDataSource datasource() {
		...
		ds.setJdbcUrl(env.getProperty("db.url", "jdbc:mysql://localhost:3306/mongorels?autoReconnect=true"));
		ds.setUsername(env.getProperty("db.user.name", "root"));
		ds.setPassword(env.getProperty("db.user.password", "wordpass15"));
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factory.setPackagesToScan("com.yookos.recommendations.jpa.entities");
